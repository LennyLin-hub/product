...
import com.product.common.core.page.PageDomain;
import com.product.common.core.page.TableDataInfo;
import com.product.common.core.page.TableSupport;
...
public class BaseController
{
     ...
     * 设置请求排序数据
     */
    protected <T> void startOrderBy(Page<T> page)
    {
        PageDomain pageDomain = TableSupport.buildPageRequest();
        if (StringUtils.isNotEmpty(pageDomain.getOrderBy()))
        {
            String orderBy = SqlUtil.escapeOrderBySql(pageDomain.getOrderBy());
            List<OrderItem> orderItems = PageUtils.handleOrderBy(orderBy);
